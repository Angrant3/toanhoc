...
class cap3_baigiai : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val calculationsRef = database.getReference("bai_toan_cap3")
        var dem = 0
        var sobai = 0
        var dung = 0
        var sai = 0
