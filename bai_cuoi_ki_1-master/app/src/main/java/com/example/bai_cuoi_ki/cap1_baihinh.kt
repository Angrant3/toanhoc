...
class cap1_baihinh : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val calculationsRef = database.getReference("Bai_hinh")
        var dem = 0
        var sobai = 0
        var dung = 0
        var sai = 0
        ...
        chuyen1.setOnClickListener {
            if (sobai >= maxBai) {
                ...
                val chuDe = "bài tập trắc nghiệm toán hình cấp 1"
                val ngayThang = SimpleDateFormat("dd/MM/yyyy", Locale.getDefault()).format(Date())
                val baigiai: String="baihinhcap1"
