...
class cap2_baihinh : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val calculationsRef = database.getReference("Bai_hinh_cap2")
        var dem = 0
        var sobai = 0
        var dung = 0
        var sai = 0
        ...
        chuyen1.setOnClickListener {
            if (sobai >= maxBai) {
                ...
                val chuDe = "bài tập trắc nghiệm toán hình cấp 2"
                val ngayThang = SimpleDateFormat("dd/MM/yyyy", Locale.getDefault()).format(Date())
                val baigiai: String="baihinhcap2"
